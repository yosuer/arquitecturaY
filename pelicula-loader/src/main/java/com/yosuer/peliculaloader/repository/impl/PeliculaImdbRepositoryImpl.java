...
public class PeliculaImdbRepositoryImpl implements PeliculaImdbRepository {
    ...
    private static final Logger logger = getLogger(PeliculaImdbRepositoryImpl.class);
    private static final String PARAM_TITLE = "t";

    @Autowired
    private RestTemplate restTemplateOmdb;
    ...
    public PeliculaImdb getByTitle(String title) {
        ...
        peliculaImdb = restTemplateOmdb.getForObject(uriOmdbApi, PeliculaImdb.class);
